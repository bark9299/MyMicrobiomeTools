...
#' If I want to find what microbial taxa are only in the gills compared to all other body sites, I would make sure all the other body site samples are
#' in the phyloseq object. If I only wanted to compare, lets say gills and skin samples, I would only have those sample types in the table.
#'
